...
I am a first-year PhD student in the [statistics department](https://statistics.berkeley.edu/) at the University of California, Berkeley. My current research has a number of directions: causal inference and optimal transport, estimation of dynamical systems from data ([under Giles Hooker](https://www.gileshooker.com/)), and developing statistical methodology for scRNA-seq data. I am also interested in signal processing and applications of statistics to music technology ([under Elizabeth Purdom](https://www.stat.berkeley.edu/~epurdom/)).
